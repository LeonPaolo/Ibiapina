       ...
       <div class="row">  
          <div class="col-lg-12">   
            <div class="card card-primary ">
              ...
              <form role="form" id="form_produto" action="{{route('Produtos.store')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group  col-lg-4">
                            <label for="produto"> Nome: </label>
                            <input type="text" id="produto"  name="nome" required class="form-control" placeholder="Nome do produto" >
                        </div> 
                        <div class="form-group col-lg-4">
