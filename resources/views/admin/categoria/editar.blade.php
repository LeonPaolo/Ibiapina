       ...
       <div class="row">  
          <div class="col-lg-12">   
            <div class="card card-primary ">
              ...
              <form role="form" id="form_categoria" action="{{route('Categorias.update', $categoria->id)}}" method="post" accept-charset="utf-8" >
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-row">
                      <div class="form-group  col-lg-12">
                          ...
                          <input type="text" id="categoria"  name="nome" required class="form-control @error('nome') is-invalid @enderror" value="{{ $categoria->nome }}" >
                          @error('nome')
