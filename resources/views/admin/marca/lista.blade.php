...
@section('content_header')
    <div class="content-header">  
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="">Lista de marcas
                    </h4>
                </div>
                <div class="col-sm-6">
                    <a href="{{route('Marcas.create')}}" class=" float-right ">
                    <div class="p-2 ">
        ...
        <div class="card  col-lg-12 card-outline card-info">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$marca->nome}}</td>
                    <td>
                        <a class="acessibilidade mr-2 btn btn-info btn-sm" href="{{route('Marcas.edit', $marca->id)}}" > <i class="fas fa-edit"></i> Editar</a>
                    </td>
                </tr>  
                @empty
