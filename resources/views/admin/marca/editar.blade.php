       ...
       <div class="row">  
          <div class="col-lg-12">   
            <div class="card card-primary ">
              ...
              <form role="form" id="form_marca" action="{{route('Marcas.update', $marca->id)}}" method="post" accept-charset="utf-8" >
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-row">
                      <div class="form-group  col-lg-12">
                          ...
                          <input type="text" id="marca"  name="nome" required class="form-control @error('nome') is-invalid @enderror" value="{{ $marca->nome }}" >
                          @error('nome')
